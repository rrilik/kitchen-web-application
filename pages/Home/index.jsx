...
function Home() {
    ...
    const options = {
        ...
        title: {
            align: "center",
            text: "Графік продажів магазинів по місяцях у 2023 році",
            style: {
    ...
    return (
        <div className="pt-10 ">
            <div className="grid grid-cols-3 gap-10 mb-10">
                <ChartChildren
                    bg="bg-orange-500"
                    label="Номер рахунку-фактури в очікуванні"
                    count={dataCt?.count?.pendingOrder}
                />
                <ChartChildren
                    bg="bg-blue-500"
                    label="Номер накладної в дорозі"
                    count={dataCt?.count?.shippingOrder}
                />
                <ChartChildren
                    bg="bg-pink-500"
                    label="Кількість людей, які регулярно займаються спортом"
